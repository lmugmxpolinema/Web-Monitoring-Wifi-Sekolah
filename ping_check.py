...
import routeros_api
import os  # added to read FLASK_SERVER_URL from env
...
FLASK_SERVER_URL = os.getenv('FLASK_SERVER_URL', 'http://127.0.0.1:8274')  # updated default port to match gunicorn binding
PING_INTERVAL = 30
